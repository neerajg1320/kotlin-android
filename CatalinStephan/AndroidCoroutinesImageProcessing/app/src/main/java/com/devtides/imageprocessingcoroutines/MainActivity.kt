...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        coroutineScope.launch {
            ...
            val filteredDeffered = coroutineScope.async(Dispatchers.Default) {
                processImage(originalBitmap)
            }

            val filteredBitmap = filteredDeffered.await()
    ...
    private fun processImage(bmp: Bitmap): Bitmap = Filter.apply(bmp)
